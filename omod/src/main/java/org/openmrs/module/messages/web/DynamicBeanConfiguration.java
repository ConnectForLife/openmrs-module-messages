...
package org.openmrs.module.messages.web;
...
@Configuration("messages.dynamicBeanConfiguration")
...
public class DynamicBeanConfiguration {
   ...
   */
  @Bean(name = "messagesModuleJsonConverter")
  ...
  public AbstractHandlerExceptionResolver getHandlerExceptionResolver() throws Exception {
    ...
    HttpMessageConverter<?> stringHttpMessageConverter = Context.getRegisteredComponent(
        "messagesModuleStringConverter", HttpMessageConverter.class);

    HttpMessageConverter<?> jsonHttpMessageConverter = Context.getRegisteredComponent("messagesModuleJsonConverter",
