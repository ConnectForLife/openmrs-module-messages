...
public interface MessagingService extends BaseOpenmrsCriteriaDataService<ScheduledService> {
    ...
    ActorResponse registerResponse(Integer actorId, Integer patientId, String sourceId, String sourceType,
     ...
     */
    @SuppressWarnings("checkstyle:ParameterNumber")
    ScheduledService registerResponseAndStatus(Integer scheduledId, Integer questionId, String textQuestion,
    ...
    @SuppressWarnings("checkstyle:ParameterNumber")
    ScheduledService registerResponseAndStatus(Integer scheduledId, Integer questionId, String textQuestion,
                                               Integer responseId, String textResponse, ServiceStatus status, Date timestamp,
                                               String executionId);
     ...
     */
    List<ServiceResultList> retrieveAllServiceExecutions(Integer patientId, ZonedDateTime startDate, ZonedDateTime endDate);
    ...
    List<ServiceResultList> retrieveAllServiceExecutions(ZonedDateTime startDate, ZonedDateTime endDate);
     ...
     */
    List<ActorResponse> getLastActorResponsesForConceptQuestion(Integer patientId, Integer actorId,
     ...
     */
    List<ActorResponse> getLastActorResponsesForTextQuestion(Integer patientId, Integer actorId, String textQuestion,
                                                             Integer pageSize);
     ...
     * @return
     */
    List<ActorResponse> getLastActorResponsesForServiceType(Integer patientId, Integer actorId, String serviceType,
                                                            Integer limit);
     ...
     * @return list of all service executions in the given period
     */
    List<ServiceResultList> retrieveAllServiceExecutionsForActor(Integer personId, ZonedDateTime startDate,
