...
public class ServiceResultListTest {
    ...
    private static final List<ZonedDateTime> EXEC_DATES =
            Arrays.asList(START_DATE.plusDays(10), START_DATE.plusDays(10), START_DATE.plusDays(16), START_DATE.plusDays(10),
    ...
    private static final List<String> CHANNEL_NAMES = Arrays.asList("Call", "Call", "Sms", "Call", "Deactivate service");
    private static final List<ServiceStatus> SERVICE_STATUSES =
            Arrays.asList(ServiceStatus.FUTURE, ServiceStatus.DELIVERED, ServiceStatus.PENDING, null, ServiceStatus.FAILED);
    ...
    private List<Map<String, Object>> buildRows() {
        ...
        for (int i = 0; i < EXEC_DATES.size(); i++) {
            ...
            row.put(ServiceResult.STATUS_COL_ALIAS,
